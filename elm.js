...
Elm.Slides.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getSlide = F2(function (index,slides$) {
      var _p0 = A2($Array.get,index,slides$);
      if (_p0.ctor === "Just") {
            return _p0._0.html;
         } else {
            return A2($Html.h1,_U.list([]),_U.list([$Html.text("404 Not Found")]));
         }
   });
   ...
   var slides = $Array.fromList(_U.list([A3(Slide,
                                        ...
                                        A2($Html.section,
                                        _U.list([$Html$Attributes.$class("col-md-12")]),
                                        _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text("User-Focused Language")]))
                                                ,A2($Html.ul,
                                                _U.list([]),
                                                _U.list([A2($Html.li,_U.list([]),_U.list([$Html.text("Gradual Learning")]))
                                        ...
                                        A2($Html.section,
                                        _U.list([$Html$Attributes.$class("col-md-12")]),
                                        _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text("Gradual Learning")]))
                                                ,A2($Html.h2,_U.list([]),_U.list([$Html.text("The StartApp module slowly teaches you the Elm Architecture")]))
                                                ,A2($Html.h2,_U.list([]),_U.list([$Html.text("Get ready for da code!")]))]))))
                                        ,A3(Slide,
                                        "Elm principles",
                                        12,
                                        A2(slideBasicTemplate,
                                        ...
                                        A2($Html.section,
                                        _U.list([$Html$Attributes.$class("col-md-12")]),
                                        _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text("Tooling")]))
                                                ,A2($Html.ul,
                                                _U.list([]),
